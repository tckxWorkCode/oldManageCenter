      ...
      <div class="wrap">
        <div class="search">
          <el-form :inline="true" :model="formInline" ref="formInline" class="formInline" size="small" @submit.native.prevent>
            ...
            <el-form-item label="创建日期：" prop="startDate" v-show="advancedSearch==true">
        ...
        <div class="mainContainer">
          ...
          <el-table :data="keyfileData" size="small" tooltip-effect="light" 
            ...
            @sort-change='sortChange' :cell-style="{color: 'rgba(0, 0, 0, 0.9)'}" style="width: 99.9%;font-size: 14px" :fit='true'>
            <template slot="empty">
              <div>暂无数据</div>
            </template>
            <el-table-column type="index" :index="indexMethod" label="序号" width="50px"></el-table-column>
            <el-table-column prop="nodeName" label="终端名称" min-width="90%"></el-table-column>
            <el-table-column prop="nodeIp" label="IP" min-width="90%">
              <!-- <template slot-scope="scope">
                <a @click="openDialog(scope.row)" style="color:#1ac492;cursor:pointer">{{scope.row.nodeIp}}</a>
              </template> -->
            </el-table-column>
            <el-table-column prop="path" label="文件路径" min-width="140%"></el-table-column>
            <el-table-column prop="hash" label="HASH" min-width="180%"></el-table-column>
            <el-table-column prop="status" label="状态" min-width="100%" :formatter="statusVal"></el-table-column>
            <el-table-column prop="createTime" label="创建时间" min-width="100%" sortable='custom'></el-table-column>
            <el-table-column prop="collectTime" label="采集时间" min-width="100%" sortable='custom'></el-table-column>
            <!-- <el-table-column fixed="right" label="操作" align="left">
              <template slot-scope="props">
                <el-button style="color:#1ac492" type="text" @click="viewRecord(props.row)">查看记录</el-button>
              </template>
            </el-table-column> -->
          </el-table>
  ...
  methods: {  
    ...
    reacquisition(row) {
      ...
      this.$confirm("是否重新采集信息？","提示", {
        ...
        request({url: "/sec/collectFileInfo",method: "post",
          data: {
            node_id:row.node_id,
            path:row.path,
          },
