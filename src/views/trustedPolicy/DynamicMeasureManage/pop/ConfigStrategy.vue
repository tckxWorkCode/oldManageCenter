    ...
    <el-form :label-position="labelPosition" label-width="100px" :rules="rules" :model="ruleForm" ref="ruleForm" size="small" class="form">
      ...
      <el-form-item label="策略配置：">
        <div style="display:flex">
          ...
          <div>
            <el-checkbox :true-label="1" :false-label="0" v-model="ruleForm.moduleListSwitch">模块列表(module_list)</el-checkbox>
            <el-checkbox :true-label="1" :false-label="0" v-model="ruleForm.filesystemSwitch">文件系统(filesystem)</el-checkbox>
            <el-checkbox :true-label="1" :false-label="0" v-model="ruleForm.networkSwitch">网络协议(network)</el-checkbox>
          </div>
        </div>
      </el-form-item>
    </el-form>
        ...
        if (valid) { 
          ...
          request({
            ...
            data: {
              ...
              filesystemInterval: timeInterval,
