<template>
  <div class="main">
      ...
      <div class="wrap">
        ...
        <div class="mainContainer">
          ...
          <el-table :data="dynamicMeasureData" size="small" ref="dynamicMeasureTable" tooltip-effect="light" 
            ...
            @sort-change='sortChange' :cell-style="{padding:'0px',color: 'rgba(0, 0, 0, 0.9)'}" style="width: 99%;font-size: 14px"   :fit='true' 
               row-key="nodeid" class="dynMeasureTable">
            <template slot="empty">
              <div>暂无数据</div>
            </template>
            <el-table-column type="index" :index="indexMethod" label="序号" width="100px"></el-table-column>
            <el-table-column prop="name" label="终端名称" show-overflow-tooltip min-width="110%"></el-table-column>
            ...
            <el-table-column prop="updateDate" label="更新时间" sortable='custom' show-overflow-tooltip></el-table-column>
    ...
    <div v-if="mask==true" class="mask" @click="closeDialog"></div>
     <!-- 配置弹出框    -->
    <strategy-backup ref="backup" @initTable="initData"></strategy-backup>
...
import StrategyBackup from './pop/ConfigStrategyBackup.vue'
...
import StrategyDetails from '../GlobalStrategy/pop/StrategyDetails.vue';
export default {
  name:"DynamicMeasure",
  components: { DynamicDetails,ConfigWin,ConfigStrategy,StrategyDetails,StrategyBackup },
  data() {
    return {
      loading:false,
      formInline:{
