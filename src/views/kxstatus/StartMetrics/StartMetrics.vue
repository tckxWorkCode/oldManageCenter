<template>
  <div class="main">
      ...
      <div class="wrap">
        ...
        <div class="mainContainer">
          ...
          <el-table :data="startMeasureData" size="mini" ref="startMeasureTable" tooltip-effect="light" 
            ...
            @sort-change='sortChange' :cell-style="{color: 'rgba(0, 0, 0, 0.9)',padding:'0px'}" style="width: 99%;font-size: 14px"   :fit='true' row-key="nodeId">
            <template slot="empty">
              <div>暂无数据</div>
            </template>
            ...
            <el-table-column fixed="right" label="操作" min-width="100%">
              <template slot-scope="scope">
                ...
                <el-button type="text" style="color:#1ac492" @click="policyRecord(scope.row)">查看记录</el-button>
    ...
    <measure-record ref="record"></measure-record>
  </div>
</template>
<script>
