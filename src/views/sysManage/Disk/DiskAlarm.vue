<template>
  <div>
    <div class="topNav">
      <el-breadcrumb class="breadNav" separator-class="el-icon-arrow-right">
        <el-breadcrumb-item class="crumb1"><i class="el-icon-s-home" style="padding-right: 5px"></i>位置：系统设置</el-breadcrumb-item>
        <el-breadcrumb-item class="crumb2">系统设置</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="wrap">
...
.topNav {
  font-size: 14px;
  height: 60px;
  box-shadow:3px 6px 6px 0px rgb(118 150 249 / 15%) inset;
}
.breadNav {
  margin-left: 50px;
  padding-top: 25px;
