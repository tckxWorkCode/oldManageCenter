    ...
    <div class="container">
      <div class="topNav">
        <el-breadcrumb class="breadNav" separator="/">
          ...
          <el-breadcrumb-item class="crumb2">网络管理日志</el-breadcrumb-item>
        </el-breadcrumb>
      ...
      <div class="wrap">
        ...
        <div class="mainContainer">
          ...
          <div class="popBtn">
            <el-button class="operateBtn" size="small" @click="exportData" :disabled="networkLogData.length==0">导出</el-button>
          </div>
          <el-table :data="networkLogData" size="small" ref="startLogTable" tooltip-effect="light" 
            ...
            <el-table-column prop="system" label="系统类型" min-width="90%" show-overflow-tooltip>
            ...
            <el-table-column prop="destip" label="目标IP"></el-table-column>
            <el-table-column prop="srcport" label="源端口"></el-table-column>
            <el-table-column prop="destport" label="目标端口"></el-table-column>
            <el-table-column prop="protocol" label="协议">
              <template slot-scope="props">
                <span v-if="props.row.protocol == '0'">IP</span>
                <span v-else-if="props.row.protocol == '1'">ICMP</span>
                <span v-else-if="props.row.protocol == '2'">IGMP</span>
                <span v-else-if="props.row.protocol == '4'">IPIP</span>
                <span v-else-if="props.row.protocol == '6'">TCP</span>
                <span v-else-if="props.row.protocol == '8'">EGP</span>
                <span v-else-if="props.row.protocol == '12'">PUP</span>
                <span v-else-if="props.row.protocol == '17'">UDP</span>

                <span v-else-if="props.row.protocol == '22'">IDP</span>
                <span v-else-if="props.row.protocol == '29'">TP</span>
                <span v-else-if="props.row.protocol == '33'">DCCP</span>
                <span v-else-if="props.row.protocol == '41'">IPV6</span>
                <span v-else-if="props.row.protocol == '46'">RSVP</span>
                <span v-else-if="props.row.protocol == '47'">GRE</span>
                
                <span v-else-if="props.row.protocol == '50'">ESP</span>
                <span v-else-if="props.row.protocol == '51'">AH</span>
                <span v-else-if="props.row.protocol == '92'">MTP</span>
                <span v-else-if="props.row.protocol == '94'">BEETPH</span>
                <span v-else-if="props.row.protocol == '98'">ENCAP</span>
                <span v-else-if="props.row.protocol == '103'">PIM</span>
                <span v-else-if="props.row.protocol == '108'">COMP</span>

                <span v-else-if="props.row.protocol == '132'">SCTP</span>
                <span v-else-if="props.row.protocol == '136'">UDPLITE</span>
                <span v-else-if="props.row.protocol == '137'">MPLS</span>
                <span v-else-if="props.row.protocol == '255'">RAW</span>
                <span v-else>其他</span>
              </template>
            </el-table-column>
            <el-table-column prop="actionType" label="动作" min-width="80%">
              <template slot-scope="props">
                <span v-if="props.row.actionType == '1'">禁止</span>
                <span v-else-if="props.row.actionType == '2'">允许</span>
                <span v-else>未知</span>
              </template>
            </el-table-column>
            <el-table-column prop="direction" label="方向">
              <template slot-scope="props">
                ...
                <span v-else-if="props.row.direction == '0'">入</span>
              </template>
            </el-table-column>
            <el-table-column prop="time" label="时间" sortable='custom' min-width="80%" show-overflow-tooltip></el-table-column>
          </el-table>
...
export default {
  ...
  methods: {  
    loadData() {
      var that = this
      this.loading = true
      request({url: "/aud/log/networkLog",method: "post",
        data: {
    ...
    exportData() {
      ...
      this.$confirm("确定导出此数据？","提示", {
        ...
        request({url: "/aud/downloadNetwork",method: "post",responseType: "blob", data: form
        }).then((response) => {
          var res = response.data
          // console.log(res)
